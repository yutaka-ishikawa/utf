...
time mpiexec -n 110592 $MPIOPT ../bin/colld -l 1 -s 0x1	#
echo "checking Reduce"
time mpiexec -n 110592 $MPIOPT ../bin/colld -l $RED_LEN -s 0x2	#
echo; echo; echo
echo "checking Allreduce"
time mpiexec -n 110592 $MPIOPT ../bin/colld -l $RED_LEN -s 0x4	#
echo; echo; echo
echo "checking Gather"
time mpiexec -n 110592 $MPIOPT ../bin/colld -l $GS_LEN -s 0x8	#
echo; echo; echo
echo "checking Scatter"
time mpiexec -n 110592 $MPIOPT ../bin/colld -l $GS_LEN -s 0x20	#
#
echo; echo; echo
