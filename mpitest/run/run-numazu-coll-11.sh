#!/bin/bash
#------ pjsub option --------#
#PJM -N "MPICH-COLL11" # jobname
#PJM -S		# output statistics
#PJM --spath "results/coll-11/%n.%j.stat"
#PJM -o "results/coll-11/%n.%j.out"
#PJM -e "results/coll-11/%n.%j.err"
#
...
mpiexec -np 11 ../bin/coll -l 10 -V -v 0x3f -i 10
