...
#PJM --spath "results/coll-mck1-2/%n.%j.stat"
#PJM -o "results/coll-mck1-2/%n.%j.out"
#PJM -e "results/coll-mck1-2/%n.%j.err"
#
#	PJM --spath "results/coll-mck1-l512/%n.%j.stat"
#	PJM -o "results/coll-mck1-l512/%n.%j.out"
#	PJM -e "results/coll-mck1-l512/%n.%j.err"
#
#	PJM --spath "results/coll-192-mck1-l512/%n.%j.stat"
#	PJM -o "results/coll-192-mck1-l512/%n.%j.out"
#	PJM -e "results/coll-192-mck1-l512/%n.%j.err"
#
...
#export MPIR_CVAR_ALLTOALL_SHORT_MSG_SIZE=1099511627776	# 1GB does not work !!!

export MPIR_CVAR_ALLTOALL_MEDIUM_MSG_SIZE=10
...
#export TOFULOG_DIR=./results/coll-192-mck1-l512/
#export TOFULOG_DIR=./results/coll-mck1-l512/
...
mpiexec ../bin/coll -l 51200 -v
#mpiexec ../bin/coll -l 256 -v
#mpiexec ../bin/coll -l 8 -v	# NO 3072 (16*192)
#mpiexec ../bin/coll -l 4 -v	# OK 1536 (8*192) without print
echo
echo
ldd ../bin/coll
